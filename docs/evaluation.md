...
- AI依頼の期日と優先度を、そこから生じたユーザー確認項目へ引き継ぐ。
- ユーザーの回答を履歴へ残し、回答後にリンク済みAIタスクを再開する。
- 通常契約を一律にユーザーへ承認させず、実際に必要な判断だけをユーザータスクにする。
...
Allama v0.2の製品目標は、rawなSWE-benchの首位ではなく、仕事の入口を1か所へ集約しながら、無断変更ゼロ、要相談イベント検出100%、
